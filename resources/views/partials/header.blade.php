...
<header class="sticky top-0 z-50 bg-white shadow-sm backdrop-blur-sm backdrop-saturate-150">
  <nav class="max-w-[1200px] mx-auto flex items-center justify-between px-6 py-4">
    ...
    <ul class="hidden md:flex space-x-10 font-medium text-gray-600">
      <li><a href="{{route('admin.products')}}" class="hover:text-blue-600 transition-colors duration-300">Products</a>
      </li>
      <li><a href="{{route('admin.categories')}}"
          class="hover:text-blue-600 transition-colors duration-300">Categories</a></li>
      ...
      <li><a href="{{route('admin.logs')}}" class="hover:text-blue-600 transition-colors duration-300">Activity Logs</a>
      </li>
    </ul>
