...
<body class="flex flex-col min-h-screen">
    ...
    <main class="flex-grow max-w-6xl mx-auto px-6 py-20">
        ...
        <!-- Search Bar -->
        <div class="mb-4">
            <input type="text" placeholder="Search a Product" class="border border-gray-300 rounded-lg px-4 py-2 w-full" />
        </div>

        <!-- Add Product Button -->
        <a href="/products/create" class="bg-blue-600 text-white px-4 py-2 rounded mb-4 inline-block">Add Product</a>
            ...
            <table class="min-w-full bg-white border border-gray-200">
                ...
                <tbody>
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <a href="/products/edit/1" class="text-blue-600 hover:underline">Edit</a>
                            <form action="/products/1" method="POST" class="inline">
